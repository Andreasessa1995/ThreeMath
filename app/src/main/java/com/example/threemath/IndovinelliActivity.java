...
public class IndovinelliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_indovinelli);
    ...
    public void insertDomandeLV1_1() {
        quesito.clear();
        Domanda domanda1 = new Domanda("Vedo avanti e non mi sposto.", "orologio", "palazzo", "treno", "televisore");
        quesito.add(domanda1);
        Domanda domanda2 = new Domanda("Ciambella con  un proiettile al centro.", "Dolcezza letale", "Il dolce a volte ammazza", "Ultima ciambella", "Buco rosso");
        quesito.add(domanda2);
        Domanda domanda3 = new Domanda("Mi prendi di notte, mi lasci di giorno, non soffri se mi hai ma se torno.", "Sonno", "Animale", "Treno", "Taxi");
        quesito.add(domanda3);
        Domanda domanda4 = new Domanda("Ho un vita breve, produco quello che mi distrugge, sono lenta e ho paura del vento.", "Candella", "Camino", "Stufa", "Lampada");
        quesito.add(domanda4);
        Domanda domanda5 = new Domanda("Tutti lo aprono ma nessuno lo chiude.", "Uovo", "Regalo", "Scatola di cioccolattini", "Tesoro");
    ...
    public void insertDomandeLV1_2_1() {
        ...
        quesito.clear();
        Domanda domanda1 = new Domanda("Viene salutata solo se è alzata.", "Bandiera", "Maestra", "Amico", "Re");
        quesito.add(domanda1);
        Domanda domanda2 = new Domanda("Quando viene il freddo si spoglia.", "Albero", "Torta", "Pinguono", "Orso polare");
        quesito.add(domanda2);
        Domanda domanda3 = new Domanda("A volte balla e cade.", "Dente", "Ballerino", "Bicchiere", "Specchio");
        quesito.add(domanda3);
        Domanda domanda4 = new Domanda(" É alta come il palazzo ma è più leggera. ", "La sua ombra", "Mongolfiera", "Palloncino", "Nuovola");
        quesito.add(domanda4);
        Domanda domanda5 = new Domanda("Se mi lasci aperto perdo.", "Rubinetto", "Porta", "Camino", "Finestra");
        quesito.add(domanda5);
    ...
    public void insertDomandeLV1_3() {
        ...
        quesito.clear();
        Domanda domanda1 = new Domanda("Una volta detto non lo sono più", "Segreto", "Tesoro", "Silenzio", "Sorpresa");
        quesito.add(domanda1);
        Domanda domanda5 = new Domanda("Più la mia presenza è forte meno vedi", "Buio", "Luce", "Ombra", "Notte");
        quesito.add(domanda5);
        Domanda domanda2 = new Domanda("Lo tengo nella tasca ma è vuota", "Il buco", "tasca", "fondo", "Nulla");
        quesito.add(domanda2);
        Domanda domanda3 = new Domanda("Le domande non le fa ma aspetta sempre una risposta", "Telefono", "Amico", "Cuffie", "Microfono");
        quesito.add(domanda3);
        Domanda domanda4 = new Domanda("Di denti ne ho tanti ma non mordo", "Pettine", "Gatto", "Coccodrillo", "Volpe");
        quesito.add(domanda4);
    ...
    public void insertDomandeLV2_1() {
        ...
        Domanda domanda1 = new Domanda("Andrea ha 4 figlie ogni figlia ha un fratello. Quanti figli ha ?", "5", "9", "7", "2");
        quesito.add(domanda1);
    ...
    private void startTimer() {
        ...
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                mTimerRunning = false;
                disabilitaRisposte();
                Toast.makeText(IndovinelliActivity.this, "Tempo scaduto", Toast.LENGTH_LONG).show();
